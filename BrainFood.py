...
import os
os.getcwd()
os.chdir("C:/Users/matia/Documents/BrainFood")
os.getcwd()
#Import libs
...
#Importar csv
info_beer = pnda.read_csv("beer_reviews.csv")

#%%
#1.	¿Qué cervecería produce la cerveza más fuerte según ABV?

##Cervecería que produce la cerveza especifica más fuerte
#Clean Nan
...
#Result print:Cervecera con mayor ABV: Schorschbräu, Cerveza con mayor ABV: Schorschbräu Schorschbock 57%

##Cervecería que produce la cerveza general con mayor ABV
#Empty dict
cervecera_abv = {}
...
#Result print:Cervecera con mayor ABV prom: Schorschbräu, promedio de ABV: 19.228823529411763

### Se concluye que  la cervecera que produce la cerveza con mayor ABV consiste en
### Schorschbräu y la cerveza con mayor ABV: Schorschbräu Schorschbock 57%
### Luego se busco la cervecera que produce en general con mayor ABV resultando en la misma.
